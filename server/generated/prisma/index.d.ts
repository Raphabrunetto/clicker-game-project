...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      GameState: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.GameStateFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.GameStateAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export interface Prisma__UserClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    gameState<T extends User$gameStateArgs<ExtArgs> = {}>(args?: Subset<T, User$gameStateArgs<ExtArgs>>): Prisma__GameStateClient<$Result.GetResult<Prisma.$GameStatePayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | null, null, ExtArgs, GlobalOmitOptions>
    /**
  ...
  export type GameStateOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "currency" | "upgrades" | "lastSavedAt", ExtArgs["result"]["gameState"]>
  ...
  export interface GameStateDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more GameStates that matches the filter.
     * @param {GameStateFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const gameState = await prisma.gameState.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: GameStateFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a GameState.
     * @param {GameStateAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const gameState = await prisma.gameState.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: GameStateAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface GameStateFieldRefs {
    ...
    readonly currency: FieldRef<"GameState", 'BigInt'>
    readonly upgrades: FieldRef<"GameState", 'Json'>
    readonly lastSavedAt: FieldRef<"GameState", 'DateTime'>
  }
   ...
   * GameState findRaw
   */
  export type GameStateFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * GameState aggregateRaw
   */
  export type GameStateAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type GameStateWhereInput = {
    ...
    currency?: BigIntFilter<"GameState"> | bigint | number
    upgrades?: JsonFilter<"GameState">
    lastSavedAt?: DateTimeFilter<"GameState"> | Date | string
  ...
  export type GameStateScalarWhereWithAggregatesInput = {
    ...
    currency?: BigIntWithAggregatesFilter<"GameState"> | bigint | number
    upgrades?: JsonWithAggregatesFilter<"GameState">
    lastSavedAt?: DateTimeWithAggregatesFilter<"GameState"> | Date | string
  }
  ...
  export type GameStateUpdateInput = {
    currency?: BigIntFieldUpdateOperationsInput | bigint | number
    upgrades?: InputJsonValue | InputJsonValue
    lastSavedAt?: DateTimeFieldUpdateOperationsInput | Date | string
